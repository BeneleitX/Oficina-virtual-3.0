...
$menu = [
    ...
    [ "success", "valida_credenciales", "address-card", "Valida credenciales", sizeof( $credenciales ), [ "30-SOPORTE" ] ],
    ...
    [ "success", "paqueterias/".getModeloPrincipal(), "truck-fast", "Paquetería", sizeof( $paqueterias ), [ "25-PAQUETERIA", "30-SOPORTE" ] ],
    ...
    [ "success", "almacenes/".getModeloPrincipal(), "dolly", "Almacenes", sizeof( $almacenes ), ["20-ALMACEN"] ],    
    ...
    [ "warning", "isr", "filter-circle-dollar", "Tablas de ISR", 0,[] ],     
    [ "success", "layout_bancos", "money-bill-transfer", "Layout de bancos", 0,[] ],     
