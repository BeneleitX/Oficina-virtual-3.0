            ...
            <form method="post" action="<?php echo base_url( "edita_saldos" ); ?>">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-striped w-100">
                        <?php
                        foreach( MODELOS as $m ){
                            echo "\n<tr modelo=\"{$m[ "codigo" ]}\"><td style=\"width:33%\" class=\"py-3\"><span class=\"text-{$m[ "settings" ][ "color" ]}\"><i class=\"fa fa-{$m[ "settings" ][ "icono" ]}\"></i> {$m[ "nombre" ]}</span></td><td style=\"width:33%\"><input  step=\"0.01\" type=\"number\" name=\"saldo[{$m[ "codigo" ]}]\" class=\"form-control saldo text-end\"></td><td class=\"text-end py-3\" style=\"width:33%\">
            ...
            <form method="post" action="<?php echo base_url( "agrega_saldos" ); ?>">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-striped w-100">
                        <?php
                        foreach( MODELOS as $m ){
                            echo "\n<tr modelo=\"{$m[ "codigo" ]}\"><td style=\"width:33%\" class=\"py-3\"><span class=\"text-{$m[ "settings" ][ "color" ]}\"><i class=\"fa fa-{$m[ "settings" ][ "icono" ]}\"></i> {$m[ "nombre" ]}</span></td><td style=\"width:33%\"><input step=\"0.01\" type=\"number\" name=\"saldo[{$m[ "codigo" ]}]\" class=\"form-control saldo text-end\"></td><td class=\"text-end py-3\" style=\"width:33%\">&nbsp;</td></tr>";
                        }
                        ?>
                    </table>
