...
-- Dumping structure for table app_v12.t_acciones
...
-- Dumping structure for table app_v12.t_almacenes
...
-- Dumping structure for table app_v12.t_apiconsumos
...
) ENGINE=InnoDB AUTO_INCREMENT=89105 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Data exporting was unselected.

-- Dumping structure for table app_v12.t_apikeys
...
-- Dumping structure for table app_v12.t_bancos
...
-- Dumping structure for table app_v12.t_banners
...
-- Dumping structure for table app_v12.t_bitacoras
...
) ENGINE=InnoDB AUTO_INCREMENT=198866 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Data exporting was unselected.

-- Dumping structure for table app_v12.t_bloques
...
-- Dumping structure for table app_v12.t_calificaciones
...
-- Dumping structure for table app_v12.t_celulares
...
-- Dumping structure for table app_v12.t_colonias
...
) ENGINE=InnoDB AUTO_INCREMENT=142889 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Data exporting was unselected.

-- Dumping structure for table app_v12.t_comisiones
...
) ENGINE=InnoDB AUTO_INCREMENT=1448845 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Data exporting was unselected.

-- Dumping structure for table app_v12.t_compresiones
...
) ENGINE=InnoDB AUTO_INCREMENT=44011 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Data exporting was unselected.

-- Dumping structure for table app_v12.t_domicilios
...
) ENGINE=InnoDB AUTO_INCREMENT=2976 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Data exporting was unselected.

-- Dumping structure for table app_v12.t_entidades
...
-- Dumping structure for table app_v12.t_esquemas
...
-- Dumping structure for table app_v12.t_estatus
...
-- Dumping structure for table app_v12.t_fondeos
...
) ENGINE=InnoDB AUTO_INCREMENT=2797 DEFAULT CHARSET=utf8mb3;

-- Data exporting was unselected.

-- Dumping structure for table app_v12.t_gasolina
...
-- Dumping structure for table app_v12.t_isr
...
-- Dumping structure for table app_v12.t_localidades
...
-- Dumping structure for table app_v12.t_metodosentrega
...
-- Dumping structure for table app_v12.t_metodospago
...
-- Dumping structure for table app_v12.t_modelos
...
-- Dumping structure for table app_v12.t_pagos
...
) ENGINE=InnoDB AUTO_INCREMENT=80164 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Data exporting was unselected.

-- Dumping structure for table app_v12.t_pedidos
...
) ENGINE=InnoDB AUTO_INCREMENT=1126041 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Data exporting was unselected.

-- Dumping structure for table app_v12.t_periodos
...
-- Dumping structure for table app_v12.t_pines
...
-- Dumping structure for table app_v12.t_productos
...
-- Dumping structure for table app_v12.t_promociones
...
-- Dumping structure for table app_v12.t_rangos
...
-- Dumping structure for table app_v12.t_recargas
...
-- Dumping structure for table app_v12.t_recompensas
...
-- Dumping structure for table app_v12.t_redenciones
...
-- Dumping structure for table app_v12.t_roles
...
-- Dumping structure for table app_v12.t_transferencias
...
) ENGINE=InnoDB AUTO_INCREMENT=1367 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Movimientos de mercancía entre almacenes';

-- Data exporting was unselected.

-- Dumping structure for table app_v12.t_usuarios
...
) ENGINE=InnoDB AUTO_INCREMENT=160967 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Data exporting was unselected.

-- Dumping structure for table app_v12.t_variables
...
-- Dumping structure for procedure app_v12.p_avance_corte
DELIMITER //
...
-- Dumping structure for procedure app_v12.p_cobra_estrellas
DELIMITER //
...
-- Dumping structure for procedure app_v12.p_genera_pagos
DELIMITER //
...
-- Dumping structure for procedure app_v12.p_update_niveles
DELIMITER //
...
-- Dumping structure for procedure app_v12.p_update_padre
DELIMITER //
...
-- Dumping structure for procedure app_v12.p_update_rango
DELIMITER //
...
-- Dumping structure for function app_v12.f_calcula_estrellas
DELIMITER //
...
-- Dumping structure for function app_v12.f_calcula_isr
DELIMITER //
...
-- Dumping structure for function app_v12.f_checks_rango
DELIMITER //
...
BEGIN
	...
	if rango_nuevo is not null then
		...
		*/
		...
		if suma = 3 && ingresos > cantidades->>'$[0]' AND JSON_CONTAINS( splash->'$[*].tipo', '"rango"' ) IS null then 
			UPDATE t_usuarios SET 
...
-- Dumping structure for function app_v12.f_compresion_de_red
DELIMITER //
...
-- Dumping structure for function app_v12.f_compulsa_valores
DELIMITER //
...
-- Dumping structure for function app_v12.f_estrellas_en_pedido
DELIMITER //
...
-- Dumping structure for function app_v12.f_es_verificado
DELIMITER //
...
-- Dumping structure for function app_v12.f_fecha_primercompra
DELIMITER //
...
-- Dumping structure for function app_v12.f_genera_pagos
DELIMITER //
CREATE FUNCTION `f_genera_pagos`(
...
-- Dumping structure for function app_v12.f_get_avatar
DELIMITER //
...
-- Dumping structure for function app_v12.f_get_calificacion
DELIMITER //
...
-- Dumping structure for function app_v12.f_get_downline
DELIMITER //
...
-- Dumping structure for function app_v12.f_get_estatus
DELIMITER //
...
-- Dumping structure for function app_v12.f_get_factor_promos
DELIMITER //
...
-- Dumping structure for function app_v12.f_get_ingresos
DELIMITER //
...
-- Dumping structure for function app_v12.f_get_inventario
DELIMITER //
...
-- Dumping structure for function app_v12.f_get_niveles
DELIMITER //
...
-- Dumping structure for function app_v12.f_get_padre
DELIMITER //
...
-- Dumping structure for function app_v12.f_get_upline
DELIMITER //
...
BEGIN
	...
	WITH recursive cte (id, activos, avatar, nombre, iniciales, estatus, antiguedad, updated, padre, patrocinador, calificaciones, rango, nivel, profundidad) AS (
	   ...
	   UNION ALL
	    ...
	    WHERE cte.padre is NOT NULL AND CAST( cte.padre AS UNSIGNED ) > 0
	)
	SELECT * FROM cte;
...
-- Dumping structure for function app_v12.f_rasura_comision
DELIMITER //
...
-- Dumping structure for function app_v12.f_rasura_movil
DELIMITER //
...
-- Dumping structure for function app_v12.f_reparte_comisiones
DELIMITER //
...
BEGIN
	...
	DECLARE v_usuario, v_estatus, compresion, l, primercompra, v_productos, gasolinas INT;
...
-- Dumping structure for function app_v12.f_update_nivel
DELIMITER //
...
-- Dumping structure for function app_v12.f_update_PTS
DELIMITER //
