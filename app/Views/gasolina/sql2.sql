...
) ENGINE=InnoDB AUTO_INCREMENT=100197 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=246075 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=1574797 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=1129075 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
	...
	reparto: BEGIN
	    ...
	    lop_pedidos : LOOP
			...
			SET avance = JSON_SET( avance, 
				...
				'$.proceso', JSON_OBJECT( pid, JSON_ARRAY( OFFSET, step, cont, avance->'$.pedidos', porcentaje ) )
			);
			...
			DECLARE total, test_a, test_b DECIMAL(10,2) DEFAULT 0;
	 	    ...
	 	    DECLARE cur_pagos CURSOR FOR 
				...
				WHERE 
					...
					-- Esto se terminará de editar en la semana de agosto 2025, se usa temporalmente la otra para pagar el bono atrasado
...
BEGIN
	...
	SELECT 
		...
		SUBSTRING( JSON_UNQUOTE( JSON_EXTRACT( u.historial, '$.registro' ) ), 1, 10 ),
...
--	END IF;
	...
	IF baja = 1 THEN
	    -- Si ningun modelo está activo, damos de baja al socio
