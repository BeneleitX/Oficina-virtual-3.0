...
<div class="row">
    ...
    <div class="col-8 text-end pt-3">
        <h5><?php echo false ? "<a href=\"".base_url( "inversiones" )."\"class=\"btn btn-secondary me-5\"><i class=\"fa fa-dashboard\"></i> Ir a dashboard</a> " : ""; ?>Retiros aplicados en el mes: 
      ...
      //  $mes = date( "Ym" );
        ...
        foreach( $solicitudes as $s ){
            ...
            <tr socio=\"{$u->id}\">
                ...
                <td class=\"text-end\"><span class=\"text-teal fw-bold\">$".number_format( $s[ "deposito" ] > 0 ? $s[ "deposito" ] : $s[ "cantidad" ], 2 )."</span></td>
                <td><span class=\"badge bg-".( substr( $s[ "tipo" ], 0, 1) == "S" ? "red" : "marine" )."\">".( substr( $s[ "tipo" ], 0, 1) == "S" ? "SEMILLA" : $s[ "tipo" ] )."</span></td> 
