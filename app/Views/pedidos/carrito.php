                        ...
                        <ul class="nav nav-tabs mt-4" id="myTab" role="tablist">
                            <?php
                                foreach( PROMOCIONES as $p ){
                                    ...
                                    if( $p[ "estatus_codigo" ] == "201-ACTIVO" || ( $pedido[ "promociones" ][ $p[ "codigo" ] ][ "activo" ] ?? 0 ) || ( $pedido[ "PTS" ][ $p[ "codigo" ] ] ?? 0 ) ){
...
<script>
    ...
    var modelo 			= '<?php echo $modelo; ?>',
        ...
        hoy = new Date(),
        update_productos = <?php echo $update_producto ?? "0"; ?>,
