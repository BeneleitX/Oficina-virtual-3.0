...
<div class="row">
    ...
    <div class="col-lg-6">
        ...
        if( date( "d" ) < VARIABLES[ "dias_mes_anterior" ][ "valor" ] && $modelo == '10-NUTRICION' &&  !( $pagado || $bloqueado || $cancelado ) && $pc && date( "Ym" ) > date( "Ym", strtotime( $pc ) ) ){ 
            ?>
                        ...
                        if( substr( $p->estatus_codigo, 0, 3 ) > 200 ){
                            ...
                            if( $modelo == "50-INVERSION" ) {
                                echo "<div class=\"row\">
                                    ...
                                    <div class=\"col-5\">
                                        <input class=\"form-control text-end\" type=\"number\" value=\"{$p->precio->total}\" id=\"cantidad_{$p->codigo}\" readonly>
                                    </div>
