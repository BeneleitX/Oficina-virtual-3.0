...
<div class="row">
        ...
        if( $modelo == '20-TELEFONIA' ){
            ...
            echo "<div class=\"col-lg-8\">".pills( "historial", $modelo )."</div><div class=\"col-lg-4\"><a class=\"btn btn-lg mt-4 col-12 btn-secondary\" href=\"".base_url( "tienda/".$modelo )."\"><i class=\"fa fa-hand-holding-dollar\"></i> Nuevo paquete</a></div>";
        }else{
