        ...
        <?php 
            foreach( $pedidos as $p ){
                ...
                echo "</td>
                    ...
                    <td class=\"text-end\">".( $p[ "data" ][ "factura" ] ?? null ? " <small class=\"\"><span style=\"vertical-align: text-top;\" class=\"badge bg-".( $p[ "data" ][ "factura" ] == "146-FACTURA-OK" ? "teal" : "mustard" )."\">".( $p[ "data" ][ "factura" ] == "146-FACTURA-OK" ? $p[ "data" ][ "cfd" ] : "<i class=\"fa fa-file-invoice-dollar\"></i>" )."</span></small> " : "" ).( intval( substr( $p[ "estatus_codigo" ], 0, 3 ) ) < 255 ? "<span class=\"badge bg-gray-300 text-red\">Pendiente</span>" : "$".number_format( $p[ "data" ][ "total" ] + $p[ "data" ][ "comisionbanco" ] + $p[ "data" ][ "comisionentrega" ], 2 ) )."</td>
