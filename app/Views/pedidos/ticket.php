...
<div class="row mb-3">
    <div class="col-6">
        <img src="<?php echo base_url(); ?>assets/img/logo_color.png" style="width:140px;">
    </div>
    
    <div class="col-6 text-end">
        <h1 class="xmt-4">
            Pedido <span style="border:1px solid black" class="badge bg-light text-black"><?php echo $pedido[ "referencia" ]; ?></span>
        </h1>
    </div>
</div>
...
<?php
            ...
            if( $cant_productos ){
                echo "\n<div class=\"card mb-3\">
                            <div class=\"card-header bg-gray-300\">
                                <div class=\"row\">
                                    <div class=\"col-md-8\">
                                        <h5 class=\"m-0\">{$p[ "settings" ][ "nombre" ]}</h5>
                                    </div>
                                    <div class=\"col-md-4 text-end\">{$cant_productos} productos</div>
                                </div>
                            </div>
                    ...
                    echo "\n<tr>
                                <td class=\"w-100\">
                                    <div class=\"row\">
                                        ...
                                        <div class=\"col-md-10\">
                                            <h5 class=\"m-0\">{$k[ "nombre" ]}</h5>
                                            <p class=\"small mb-3\">{$k[ "descripcion" ]}</p>
                                        </div>
                                    </div>
                                </td>
                ...
                echo "\n</table>
                        <div class=\"card-footer text-end\">
                            <table align=\"right\">
                                <tr>
                                    <td>{$p[ "settings" ][ "nombre" ]} &nbsp; </td>
                                    <td>
                                        <h5 class=\"m-0\" style=\"width:120px\">$".number_format( $subtotal = ( isset( $pedido[ "promociones" ][ $p[ "codigo" ] ][ "precio"] ) ? $pedido[ "promociones" ][ $p[ "codigo" ] ][ "precio"] : 0 ), 2 )."</h5>
                                    </td>
                                </tr>
                            </table>
                        </div>
    ...
    echo "\n<div class=\"card\" style=\"overflow:hidden\">
                <div class=\"card-footer text-end bg-black text-white\">
                    <table class=\"w-100\">
                        <tr>
                            <td style=\"width:47%\">{$total_prods} productos</td>
                            <td>Sub total de productos &nbsp; </td>
                            <td style=\"width:120px\">
                                <h5 class=\"m-0 text-white\" style=\"width:120px\">$".number_format( $total_precio, 2 )."</h5>
                            </td>
                        </tr>
                    </table>
                </div>
    ...
    <div class="card mb-3">
        ...
        <div class="card-footer">
            <table class="w-100">
                <tr>
                    <td><?php echo $me[ "nombre" ]; ?></td>
                    <td><?php echo $entrega; ?></td>
                    <td class="text-end" style="width:120px">
                            <h5 class="m-0">$<?php echo number_format( $pedido[ "data" ][ "comisionentrega" ], 2 ); ?></h5>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <?php 
        ...
        echo "\n<div class=\"alert alert-danger my-3 text-red\">
                    <i class=\"fa fa-warning\"></i>
                    Este pedido no cuenta con datos de entrega ({$pedido[ "metodoentrega_codigo" ]})
                </div>";
    }
?>
    ...
    <div class="card-footer">
        <table class="w-100">
            <tr>
                ...
                <td class="text-end" style="width:120px">
                    <h5 class="m-0">$<?php echo number_format( $pedido[ "data" ][ "comisionbanco" ], 2 ); ?></h5>
                </td>
            </tr>
        </table>
    </div>
        ...
        <div class="card-footer">
            <table class="w-100">
                <tr>
                    ...
                    <td></td>
                    <td class="text-end" style="width:120px">
                        <h5 class="m-0">-$<?php echo number_format( $pedido[ "data" ][ "saldo" ] ?? 0, 2 ); ?></h5>
                    </td>
                </tr>
            </table>
        </div>
...
<div class="card mb-3" style="overflow:hidden">
    <table class="table rounded-3 m-0">
        <tr>
            <td valign="middle" class="text-white text-end" style="background:var(--bs-black) !important">Total de pedido</td>
            <td valign="middle" class="text-end" style="width:110px; background:var(--bs-black) !important">
                <h5 class="text-white my-0">$<?php echo number_format( $pedido[ "data" ][ "total" ] + $pedido[ "data" ][ "comisionentrega" ] - ( $pedido[ "data" ][ "saldo" ] ?? 0 ) + $pedido[ "data" ][ "comisionbanco" ], 2 ); ?></h5>
            </td>
        </tr>
    </table>
</div>
