...
<form method="post" action="<?php echo base_url( "procesa_registro" ); ?>">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card mb-3"><div class="card-header"><h5>Nombre de nuevo socio</h5>Escribe tu nombre tal como aparece en tu identificación oficial</div><div class="card-body">
                <label>Nombre</label>
        ...
        <div class="col-md-4">
            <div class="card mb-3"><div class="card-header"><h5>Datos de contacto</h5>Es necesario que sean reales y activos para poder enviarte información complementaria a tu registro</div><div class="card-body">
