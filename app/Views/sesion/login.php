	<div class="row">
		<div class="col-8 offset-2 col-md-4 offset-md-4 col-lg-3 offset-lg-8 " style="padding-top:50px">
			...
			<div class="card mb-3 xbg-secondary xtext-white ">
				...
				<div class="card-body">
					<form method="post" action="<?php echo base_url( "oauth" ); ?>">
						...
						<p class="text-center mt-3"><a href="<?php echo base_url( "recover" ); ?>">¿Olvidaste tu password?</a></p>
						<hr class="b-primary">
