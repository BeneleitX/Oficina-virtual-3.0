			...
			<div class="col-xl-8 offset-xl-2 col-md-8 offset-md-2">
				<div class="row">
					<div class="col-lg-6 offset-lg-3">
						...
						<p class="<?php echo $white || 1 ? "d-none" : ""; ?> text-center mb-1 mt-4 text-white"><a class="mt-2 btn btn-warning xpy-2 col-12" xhref="<?php echo base_url( "vincular" ); ?>" xstyle="font-size:1.3rem"><img src="assets/img/logo_beneleit_movil.png" style="width:70px"> &nbsp; Vincula tu línea</a></p>
