...
-- Dumping structure for procedure app_v13.p_avance_corte
DELIMITER //
...
-- Dumping structure for procedure app_v13.p_cobra_estrellas
DELIMITER //
...
-- Dumping structure for procedure app_v13.p_genera_pagos
DELIMITER //
...
-- Dumping structure for procedure app_v13.p_get_paquetes
DELIMITER //
...
-- Dumping structure for procedure app_v13.p_update_niveles
DELIMITER //
...
-- Dumping structure for procedure app_v13.p_update_padre
DELIMITER //
...
-- Dumping structure for procedure app_v13.p_update_rango
DELIMITER //
...
-- Dumping structure for function app_v13.f_calcula_estrellas
DELIMITER //
...
-- Dumping structure for function app_v13.f_calcula_isr
DELIMITER //
...
-- Dumping structure for function app_v13.f_checks_rango
DELIMITER //
...
-- Dumping structure for function app_v13.f_compresion_de_red
DELIMITER //
...
-- Dumping structure for function app_v13.f_compulsa_valores
DELIMITER //
...
-- Dumping structure for function app_v13.f_estrellas_en_pedido
DELIMITER //
...
-- Dumping structure for function app_v13.f_es_verificado
DELIMITER //
...
-- Dumping structure for function app_v13.f_fecha_primercompra
DELIMITER //
...
-- Dumping structure for function app_v13.f_get_avatar
DELIMITER //
...
-- Dumping structure for function app_v13.f_get_calificacion
DELIMITER //
...
-- Dumping structure for function app_v13.f_get_downline
DELIMITER //
...
-- Dumping structure for function app_v13.f_get_estatus
DELIMITER //
...
-- Dumping structure for function app_v13.f_get_factor_promos
DELIMITER //
...
-- Dumping structure for function app_v13.f_get_ingresos
DELIMITER //
...
-- Dumping structure for function app_v13.f_get_inventario
DELIMITER //
...
-- Dumping structure for function app_v13.f_get_niveles
DELIMITER //
...
-- Dumping structure for function app_v13.f_get_padre
DELIMITER //
...
-- Dumping structure for function app_v13.f_get_upline
DELIMITER //
...
-- Dumping structure for function app_v13.f_rasura_comision
DELIMITER //
...
-- Dumping structure for function app_v13.f_rasura_movil
DELIMITER //
...
-- Dumping structure for function app_v13.f_reparte_comisiones
DELIMITER //
...
BEGIN
	...
	DECLARE v_modelo, v_periodo, estatus_final VARCHAR(25);
    ...
    INTO  
        v_promociones, v_modelo, v_fechareparte, v_usuario, v_estatus, v_corte, v_PTS, v_productos, v_periodo
    FROM  
	 	 t_pedidos  pedido
	...
	VALUES ( 
		CONCAT( 
			...
			YEAR( v_fechareparte ), 
			IF( v_periodo = 'SEMANAL', WEEK( v_fechareparte, 3 ),  DATE_FORMAT( v_fechareparte, '%m' ) ) 
		), 
		'250-EN-PROCESO', 
		v_modelo, 
		v_periodo, 
...
-- Dumping structure for function app_v13.f_update_nivel
DELIMITER //
...
-- Dumping structure for function app_v13.f_update_PTS
DELIMITER //
...
-- Dumping structure for trigger app_v13.t_pagos_after_update
